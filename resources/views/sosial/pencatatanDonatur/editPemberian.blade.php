...
<div class="panel-heading">
    <h6 class="panel-title">EDIT PENCATATAN DONATUR</h6>
</div>
<form method="post" action="{{url('/donasi/updatepencatatan/'.$pencatatan->id)}}">
    @method('patch')
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nama" name="nama" value="{{$pencatatan->donatur->nama}}" readonly>
    </div>
    <div class="form-group">
        <label for="donasi">Donasi</label>
        <input type="text" class="form-control" id="donasi" name="donasi" readonly value="{{$pencatatan->donatur->donasi}}">
    </div>
    <div class="form-group">
