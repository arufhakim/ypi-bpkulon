...
<div class="panel-heading">
    <h6 class="panel-title">TAMBAH PENCATATAN ANAK ASUH</h6>
</div>
<form method="post" action="{{url('/bantuan/simpanpencatatan/'.$anakasuh->id)}}">
    @method('post')
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nama" name="nama" value="{{$anakasuh->nama}}" readonly>
    </div>
    <div class="form-group">
        <label for="bantuan">Bantuan</label>
        <input type="text" class="form-control" id="bantuan" name="bantuan" readonly value="{{$anakasuh->bantuan}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control  @error('jumlah') is-invalid @enderror" id="jumlah" name="jumlah" value="{{ old('jumlah') ?? $anakasuh->bantuan}}">
        @error('jumlah')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
