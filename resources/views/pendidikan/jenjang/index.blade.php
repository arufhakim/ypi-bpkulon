...
<div class="card">
    <div class="card-body">
        <div class="panel-heading">
            <h6 class="panel-title">JENJANG SANTRI</h6>
        </div>
        @include('alert')
        <a href="{{url('/jenjang/create')}}" class="btn btn-primary btn-sm" style="margin: 10px 20px 20px 0PX;"><i class="la la-plus-square"></i> Tambah </a>
            ...
            <table class="table table-bordered table-striped table-hover table-sm datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$jg->jenjang}}</td>
                        <td align="center"><a href="{{url('/jenjang/'.$jg->id.'/edit')}}" class="btn btn-primary btn-sm"><i class="la la-pencil"></i> </a></td>
                        <td align="center">
                            <form action="{{url('/jenjang/'.$jg->id)}}" method="post" class="delete">
                                @method ('delete')
                                @csrf
