...
<div class="panel-heading">
    <h6 class="panel-title">TAMBAH KATEGORI</h6>
</div>
<form method="post" action="{{url('/kategori')}}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('kategori') is-invalid @enderror" value="{{old('kategori')}}" id="kategori" placeholder="Kategori" name="kategori">
        @error('kategori')
